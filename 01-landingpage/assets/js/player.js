...
!function (e, t) {
    ...
    }(u = {exports: {}}, u.exports), u.exports), f = new WeakMap;
    ...
    var k = new WeakMap, E = new WeakMap, Player = function () {
        function Player(u) {
            var e, c = this, t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {};
            if (!function (e, t) {
    ...
    return e || (function (e) {
        ...
        if (!window.VimeoPlayerResizeEmbeds_) {
            ...
            window.addEventListener("message", function (e) {
                if (s(e.origin) && e.data && "spacechange" === e.data.event) for (var t = r.querySelectorAll("iframe"), n = 0; n < t.length; n++) if (t[n].contentWindow === e.source) {
